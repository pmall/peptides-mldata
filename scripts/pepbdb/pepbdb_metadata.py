...
def pepbdb_metadata(min_pep_len: int, max_pep_len: int, min_target_len: int, max_target_len: int, output_csv: str, archive_path: str):
...
def main():
    ...
    parser.add_argument("output", nargs="?", default="data/pepbdb-metadata.csv",
                        help="Path to the output CSV file (default: data/pepbdb-metadata.csv)")
